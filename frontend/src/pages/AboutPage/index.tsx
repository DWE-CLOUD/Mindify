          ...
          >
            ...
            <Link to={"/"} style={{ textDecoration: "none" }}>
              <Button
                size={"lg"}
                width={"max-content"}
                _hover={{ background: THEME_COLORS.paleYellow }}
                ...
                <Flex>
                  ...
                  <Stack p={4} divider={<StackDivider />} spacing="4">
                    <Box>
                      ...
                      <Text pt="2" fontSize="md">
                        Mindify is designed to help you overcome the common
                        challenges of brainstorming and productivity. With Mindify,
              ...
              <CardBody>
                <Stack divider={<StackDivider />} spacing="4">
                  <Box>
                    ...
                    <Text pt="2" fontSize="md">
                      Mindify uses speech recognition to capture your thoughts and
                  ...
                  <Stack divider={<StackDivider />} spacing="4">
                    <Box>
                      ...
                      <Text pt="2" fontSize="md">
                        ...
                        summary of your ideas, Mindify will help you turn your
                        ideas into reality. Mindify will help you visualize your
                  ...
                  <Stack divider={<StackDivider />} spacing="4">
                    <Box>
                      ...
                      <Text pt="2" fontSize="md">
                        ...
                        of your ideas? Mindify will help you answer these questions
                        and more.
                      </Text>
                    </Box>
                  </Stack>
                ...
                <CardBody>
                  <Stack divider={<StackDivider />} spacing="4">
                    <Box>
                      ...
                      <Text pt="2" fontSize="md">
                        Whether it is by yourself or in a group meeting, Mindify
